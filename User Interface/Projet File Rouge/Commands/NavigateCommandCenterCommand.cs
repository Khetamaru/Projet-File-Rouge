...
{
    public class NavigateCommandCenterCommand : CommandBase
    {
        private readonly NavigationStore navigationStore;
        public CacheStore cacheStore;

        public NavigateCommandCenterCommand(NavigationStore navigationStore, CacheStore cacheStore)
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                navigationStore.CurrentViewModel = new CommandCenterViewModel(navigationStore, cacheStore);
