...
{
    public class NavigateMissingCallDetailsCommand : CommandBase
    {
        private readonly NavigationStore navigationStore;
        public CacheStore cacheStore;

        public NavigateMissingCallDetailsCommand(NavigationStore navigationStore, CacheStore cacheStore)
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                navigationStore.CurrentViewModel = new MissingCallDetailsViewModel(navigationStore, cacheStore);
