...
{
    public class NavigateUserHistoryCommand : CommandBase
    {
        private readonly NavigationStore navigationStore;
        public CacheStore cacheStore;

        public NavigateUserHistoryCommand(NavigationStore navigationStore, CacheStore cacheStore)
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                navigationStore.CurrentViewModel = new UserHistoryViewModel(navigationStore, cacheStore);
